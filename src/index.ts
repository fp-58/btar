(() => {
    ...
    // Type imports
    type TarArchiveExport = import("../types").TarArchive;
    type TarHeader = import("../types").TarHeader;
    type TarEntry = import("../types").TarEntry;
    type TarFileOptions = import("../types").TarFileOptions;
    type TarLinkOptions = import("../types").TarLinkOptions;
    type TarDirectoryOptions = import("../types").TarDirectoryOptions;
    type TarDeviceOptions = import("../types").TarDeviceOptions;
    type TarFIFOOptions = import("../types").TarFIFOOptions;

    class TarArchive implements TarArchiveExport {
        /** A map of file paths to entry indicies. */
        #indexMap = new Map<string, number>();
        #entries: TarEntry[] = [];

        /** @see TarArchiveExport.addFile */
        ...
        /** @see TarArchiveExport.addHardlink */
        addHardlink(
        ...
        /** @see TarArchiveExport.addSymlink */
        addSymlink(
            path: string, target: string, options?: TarLinkOptions
        ): void {
        ...
        /** @see TarArchiveExport.addCharDevice */
        addCharDevice(
            path: string,
            majorId: number,
            minorId: number,
        ...
        /** @see TarArchiveExport.addBlockDevice */
        addBlockDevice(
            path: string,
            majorId: number,
            minorId: number,
        ...
        *entries(): IterableIterator<TarEntry> {
        ...
        /** @see TarArchiveExport.removeEntry */
